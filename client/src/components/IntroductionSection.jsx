        ...
        <div className="bg-zinc-900 rounded-xl p-8 md:p-12">
          <div className="flex justify-center mb-8">
            <div className="bg-black px-4 py-1 rounded-full flex items-center">
              ...
              <span className="text-xs font-medium tracking-wider text-gray-300">INTRODUCING BOLT</span>
            </div>
          </div>
          ...
          <p className="text-center text-gray-300 text-lg max-w-3xl mx-auto leading-relaxed">
            You need top-notch design to stand out in the tech world, but hiring in-house designers can be costly and time-consuming. That's when Atomic comes in.
          </p>
        </div>
      </div>
    </div>
